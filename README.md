                        ...
                        <div class="row">
                            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4 zero_mp">
                                <div class="address">
                                    ...
                                    <p>Distrito de Juan Espinoza Medrano, Apurimac, Peru</p>
                                </div>
                            </div>
                            <!--End of col-md-4-->
                            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4 zero_mp">
                        ...
                        <nav class="navbar navbar-default zero_mp ">
                            ...
                            <div class="collapse navbar-collapse zero_mp" id="bs-example-navbar-collapse-1">
                                <ul class="nav navbar-nav navbar-right main_menu">
                                    ...
                                    <li><a href="#counter">achievements</a></li>
        ...
        <section id="slider">
            <div id="carousel-example-generic" class="carousel slide carousel-fade" data-ride="carousel" data-interval="3000">
                ...
                <div class="carousel-inner" role="listbox">
                    ...
                    <div class="item">
                        <div class="slider_overlay">
                            <img src="img/ES+TT+-+pation+long+shot.jpg" alt="...">
                            <div class="carousel-caption">
                                <div class="slider_text">
                                    <h3>Agua</h3>
                                    <h2>mas limpio y seguro</h2>
                                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
                                    <a href="" class="custom_btn">Read  More</a>
                                </div>
                            </div>
                    ...
                    <div class="item">
                        <div class="slider_overlay">
                            <img src="img/inside_patio_tea_earthship.jpg" alt="...">
                            <div class="carousel-caption">
                                <div class="slider_text">
                                    <h3>Comida</h3>
                                    <h2>de nuevas variedades</h2>
                                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
                                    <a href="" class="custom_btn">Read  More</a>
                                </div>
                            </div>
